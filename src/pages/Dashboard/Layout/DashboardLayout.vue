  ...
  <div class="wrapper" :class="{'nav-open': $sidebar.showSidebar}">
    ...
    <side-bar>
      <template slot-scope="props" slot="links">
        <user-menu></user-menu>
        <sidebar-item :link="{name:'Documentation', icon:'now-ui-icons design_app'}">
        ...
        <sidebar-item :link="{name: 'Workouts', icon: 'fa fa-dumbbell'}">
          <sidebar-item :link="{name: 'Exercises', path: '/workouts/exercises' ,icon:'fa fa-running'}"></sidebar-item>
        </sidebar-item>
      </template>
    </side-bar>
